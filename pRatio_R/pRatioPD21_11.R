...
# Install packages by first time
...
source(paste0(WD,"/Config_v11.txt"))
...
# input <- "S:/U_Proteomica/UNIDAD/DatosCrudos/JuanMiguelRedondo/BVM-nitraciones/MiceMarfan/Fusion_OK/CloseS_PD2.1_concat/JM_NDplasmaBVM_TMT_Fr1.msf"
...
# output <- "C:/Users/aalfayateh/Desktop/TFM/Software_Used/Pruebas_pratio/Prueba1.txt"
################################################################################################################
