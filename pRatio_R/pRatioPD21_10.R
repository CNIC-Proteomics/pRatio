...
# input="S:/U_Proteomica/PROYECTOS/PESA_omicas/2a_Cohorte_120/Proteomics/TMT_Fraccionamiento/TMT1/MSF/FR_3/TMT1_Fr3.msf"

# output <- input

# output <- substr(output, 1, nchar(output) - 4)

# output <- paste(output,"_results.txt",sep="")
