### params
deltaMassThreshold = 10 # in ppm
deltaMassAreas = 5 # number of jumps: 1,3 or 5
input="//tierra/SC/U_Proteomica/UNIDAD/DatosCrudos/Gencode/Mouse/20120821_EXQ5_KiSh_SA_Collab_neuroA_insol_3/20140711_EXQ00_KiSh_SA_Brain_1.msf"
output="//tierra/SC/U_Proteomica/UNIDAD/DatosCrudos/Gencode/Mouse/20120821_EXQ5_KiSh_SA_Collab_neuroA_insol_3/20140711_EXQ00_KiSh_SA_Brain_4.txt"

#input="c:/Users/iezkurdia/Desktop/20140711_EXQ00_KiSh_SA_Brain_4.msf"
#output="c:/Users/iezkurdia/Desktop/20140711_EXQ00_KiSh_SA_Brain_4.xcorrcor.txt"
...
#files=list.files(path="//tierra/SC/U_Proteomica/UNIDAD/DatosCrudos/Gencode/Mouse/")


#files=list.files(path="//tierra/SC/U_Proteomica/UNIDAD/DatosCrudos/Gencode/Mouse/last/", pattern=".+msf$")
#for (f in files)
#{
  
#input=paste("//tierra/SC/U_Proteomica/UNIDAD/DatosCrudos/Gencode/Mouse/last/",f,sep="")
#output=paste(f,".txt",sep="")
...
#SIMPLYFIED
resPratio <- resPratio[,c("FileName","RAWFile","FirstScan","LastScan","Charge","Sequence","Xcorr1Search","FDR","Redundances")]
